  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2">
        <Link to="/point/charge" className="flex-1 py-2.5 text-center border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          충전하기
        </Link>
        <Link to="/point/withdraw" className="flex-1 py-2.5 text-center border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          출금하기
        </Link>
      </div>
