...
export const MOCK_ITEMS: Item[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  price: [180000, 1650000, 0, 0, 45000, 55000, 780000, 0, 650000, 280000,
          15000, 0, 320000, 250000, 450000, 200000, 180000, 0, 350000, 0][i],
  rentPrice: [8000, 20000, 0, 0, 5000, 7000, 25000, 15000, 0, 12000,
              4000, 0, 15000, 18000, 0, 9000, 5000, 0, 12000, 3000][i],
  ...
  brand: ['apple','apple','canon',undefined,'nike','nespresso','apple',undefined,'samsung',undefined,
          undefined,undefined,'sony','nintendo','dyson',undefined,undefined,'lg','samsung',undefined][i],
  isEscrow: [true,false,true,false,true,false,true,false,true,false,true,false,true,false,true,false,true,false,true,false][i],
  hashtags: [
